...
use tree_stack_automaton::TreeStackInstruction;
...
//ptk
impl<N1: Ord + PartialEq + Debug + Clone + Hash, T: Ord, W: Ord> IntApproximationStrategy<N1, N1, PDTopKElement<usize, Transition<PushDownInstruction<usize>, T, W>,
                                                                       TransitionKey<PushDownInstruction<usize>, T, W>>>
    for PDTopKElement<N1, Transition<PushDownInstruction<N1>, T, W>,
                          TransitionKey<PushDownInstruction<N1>, T, W>>{

    fn integerise(&self, inter: &HashIntegeriser<N1>)-> (HashIntegeriser<N1>, PDTopKElement<usize, Transition<PushDownInstruction<usize>, T, W>,
                                         TransitionKey<PushDownInstruction<usize>, T, W>>){
...
impl<A1: Ord + PartialEq + Debug + Clone + Hash + Relabel<N1, N2, A2>,
     ...
     N2: Clone + Eq + Hash,
     T: Ord,
     W: Ord> IntApproximationStrategy<A1, A2, RlbElement<PushDown<usize>, usize, usize, Transition<PushDownInstruction<usize>, T, W>, TransitionKey<PushDownInstruction<usize>, T, W>>>
    for RlbElement<PushDown<A1>, N1, N2, Transition<PushDownInstruction<A1>, T, W>, TransitionKey<PushDownInstruction<A2>, T, W>>{

    fn integerise(&self, inter: &HashIntegeriser<A1>)-> (HashIntegeriser<A2>, RlbElement<PushDown<usize>, usize, usize, Transition<PushDownInstruction<usize>, T, W>, TransitionKey<PushDownInstruction<usize>, T, W>>){
...
impl<N1: Ord + PartialEq + Debug + Clone + Hash, T: Ord, W: Ord>
    IntApproximationStrategy<N1, N1, TTSElement<usize, Transition<TreeStackInstruction<usize>, T, W>,
                                                        TransitionKey<PushDownInstruction<usize>, T, W>>>
    for TTSElement<N1, Transition<TreeStackInstruction<N1>, T, W>,
                          TransitionKey<PushDownInstruction<N1>, T, W>>{

    fn integerise(&self, inter: &HashIntegeriser<N1>)-> (HashIntegeriser<N1>, TTSElement<usize, Transition<TreeStackInstruction<usize>, T, W>,
                                         TransitionKey<PushDownInstruction<usize>, T, W>>){
