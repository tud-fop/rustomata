...
impl<A:  Ord + PartialEq + Debug + Clone + Hash, B: Eq + Hash + Clone,  W: Ord + Eq + Clone> IntegerisableM<Configuration<TreeStack<u64>, u64, W>, A, B>
 ...
 impl<A:  Ord + PartialEq + Debug + Clone + Hash, B: Eq + Hash + Clone,  W: Ord + Eq + Clone> IntegerisableM<TreeStackAutomaton<u64, u64, W>, A, B>
 ...
 impl <A: Ord + PartialEq + Debug + Clone + Hash,
       ...
       where W : Add<Output = W>{
           ...
           fn approximation(&self, strati : &S) -> Result<(IntPushDownAutomaton<B, T, W>, S2), String>{
               ...
               let i = self.automaton.initial.tree.get(&Vec::new()).unwrap();
